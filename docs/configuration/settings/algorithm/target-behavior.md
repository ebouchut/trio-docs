...
The Half Basal Exercise Target allows you to scale down your basal insulin during exercise or scale up your basal insulin when eating soon by setting a manual temp target. To scale down for exercise, set a temp target above 100 mg/dL. To scale up for eating soon, set a temp target below 100 mg/dL.
